        ...
        <section class="container">
            <div class="descrition ">
                <% while (rs.next()) {
                        ...
                        image = rs.getBlob("PIC2");
                        imgData = image.getBytes(1, (int) image.length());
                        String encodedImage = Base64.getEncoder().encodeToString(imgData);
                        String pic = "data:image/jpg;base64," + encodedImage;
                %>

                <div class="row more m-3">
                    <div class="col-5"><img src="<%=pic%>" class="card-img-top" alt="..."></div>
                    <div class="col-7">
                        <div class="row title fs-3 fw-bold ">
                            <p><%=rs.getString("P_NAME")%></p>
                        </div>
                        <div class="row">
                            <p><i class="fas fa-tags"></i>By <%=rs.getString("BRAND")%></p>
                        </div>
                        <div class="row">
                            <span class="col-2 bg-danger">Save <%=rs.getString("SAVE")%>% </span>
                        </div>
                        <div class="row price">
                            <div class="col-2"><p class="fs-5 previous-price"><del>RS.<%=rs.getInt("MAIN_PRICE")%> </del></p></div>
                            <div class="col-2"><p class="fs-5 main-price"><strong>RS.<%=rs.getInt("DISC_PRICE")%></strong></p></div>
                        </div>
                        <div class="row mt-4">
                            <p><i class="fas fa-truck"></i><strong>Free Delivery Available</strong> On This Product</p>
                        </div>
                        <div class="row mt-4">
                            <p><i class="fas fa-ribbon"></i> Buy Divine Melody Premium Warranty- With Free Pickup and Return T&C*</p>
                        </div>
                        <div class="row feature mt-3">
                            <p><i class="fas fa-check-double"></i> 3 Year Standard Warranty</p>
                            <p><i class="fas fa-check-double"></i> LifeTime Tech Support</p>
                            <p><i class="fas fa-check-double"></i> 4% Cashback</p>
                            <p><i class="fas fa-check-double"></i> 15- Day Return</p>
                            <p><i class="fas fa-check-double"></i> Dedicated Product Specialists</p>
                        </div>
                        <div class="row">
                            <button class="btn" name="addToCart" 
                            onclick="window.location.href='cart.jsp?pid=<%=rs.getInt("PROD_ID")%>&pnm=<%=rs.getString("P_NAME")%>&pp=<%=rs.getInt("DISC_PRICE")%>'">
                                Add To Cart</button>
                        </div>
