...
<html>
    ...
    <body>
        ...
        <section class="container">
            <div class="descrition mt-5 mb-5">
                <h3 class="text-center mb-5">Items In Your Bag</h3>
                <%                    while (rs.next()) {
                ...
                <div class="row cart-item">
                    ...
                    <div class="col-8">
                        <div class="row"><p class="fs-5"><%=rs.getString("PROD_NM")%></p></div>
                        <div class="row"><p class="fs-5"><i class="fas fa-rupee-sign"></i> <%=rs.getInt("PRICE")%></p></div>
                    </div>
                    <div class="col-2"><button class="btn" onclick="window.location.href = 'deleteCartItem.jsp?pid=<%=rs.getInt("PROD_ID")%>'"><i class="fas fa-trash"></i>Delete</button></div>
                </div>
                <hr>
                ...
                <div class="row total">
                    <div class="col-6"><p class="fs-5">Grand Total = <i class="fas fa-rupee-sign"></i> <%=total%></p></div>
                    <div class="col-6"><a class="fs-5" href="address.jsp">Proceed To Pay</a></div>
                </div>
            </div>
        </section>
