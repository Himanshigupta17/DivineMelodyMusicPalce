...
<html>
    ...
    <body>
        ...
        <!--contact us -->
        <h3 class="title text-center mb-4">Contact Us</h3>
        <div class="content container bg-light">
            <p class="text-center">REGISTERED OFFICE:</p>
            <address class="text-center">Divine Melody Music Private Limited, Hightech Plaza, Unit - 2,<br>
                Ground Floor, VLCC compound,<br>
                Ashok Nagar, Shahdara,<br>
                Delhi-110093</address>

            <p class="text-center">** To return a product, please contact us through the form below or give us a call on +91-22-42035353</p> 

            <p class="text-center">Speak to a Product Specialist now : +91-22-42035353 / +91-22-61876973</p>

            <p class="text-center">Email Us: divineMelody@gmail.com</p> 
        </div>
