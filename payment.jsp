            ...
            <div class="row">
                ...
                <div class="pay-cred col-6">
                    <div class="row" id="credit-debit">
                        ...
                        <form action="genReciept.jsp">
                            <div class="row  mb-4">
                                <div class="col-9 form-floating">
                                    <input type="tel" class="form-control" name="cardno" id="floatingInput" placeholder="name@example.com" required>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-6 form-floating">
                                    ...
                                    <input type="month" id="expiremonth" class="form-control" placeholder="Password" name="expiremonth" required>
                                    <label for="expiremonth">MM/YY</label>
                                </div>
                                
                                <div class="col-3 form-floating">
                                    <input type="password" class="form-control" name="cvv" id="floatingPassword" placeholder="Password" required>
