        ...
        <section class="container">
            <div class="list grid-container m-3">
                ...
                <div class="card grid-item m-3 ">
                    ...
                    <div class="price">
                        <div class="save">
                            <p class="d-inline">Save <%=rs.getInt("SAVE")%>%</p>
                        </div>
                    </div>
                    <p class="previous-price"><del>Rs. <%=rs.getInt("MAIN_PRICE")%></del></p>
                    <p class="fs-5 fw-bold main-price">Rs. <%=rs.getInt("DISC_PRICE")%></p>
                    <div class="card-body">
                        <a href="" class="card-text"><%=rs.getString("P_NAME")%></a>
                    </div>
                    <div class="card-footer row ">
                        <div class="col-6"><button class="btn" name="addToCart" onclick="window.location.href = 'cart.jsp?pid=<%=rs.getInt("PROD_ID")%>&pnm=<%=rs.getString("P_NAME")%>&pp=<%=rs.getInt("DISC_PRICE")%>'">Add To Cart</button></div>
                        <div class="col-6"><button class="btn" name="viewMore" onclick="window.location.href = 'viewMore.jsp?pid=<%=rs.getInt("PROD_ID")%>'">View More</button></div>
                    </div>
                </div>
                <%}%>
