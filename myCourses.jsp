    ...
    <body>
        ...
        <%  Blob image = null;
            ...
            try {
                ...
                String qry = "select * from PURCHASED_COURSES where CUST_ID=?";
        ...
        <section class="container">
            <div class="list grid-container m-3">
                <% while (rs.next()) {
                        int pro_id = rs.getInt("ORDERID");
                        
                        String qry3 = "SELECT S.LINK, S.COURSE_NM, S.IMAGE FROM COURSE S , PURCHASED_COURSES P WHERE S.COURSE_ID=P.COURSE_ID AND P.ORDERID=?";
                ...
                <div class="card grid-item m-3 ">
                    ...
                    <div class="card-body">
                        <h4><%=rs3.getString("COURSE_NM")%></h4>
                        <p>ORDER ID : <%=rs.getInt("ORDERID")%></p>
                        <p >AMOUNT : <i class="fas fa-rupee-sign"></i> <%=rs.getInt("PRICE")%></p>
                        <p >DATE : <%=rs.getString("ORDDATE")%></p> 
                    </div>
                    <div class="card-footer row ">
                        <div class="col-12"> <a href="<%=rs3.getString("LINK")%>" target="_blank"><button class="btn" name="addToCart" >Start Learning</button></a></div>
                    </div>
                </div>
                <%}%>
            </div>
