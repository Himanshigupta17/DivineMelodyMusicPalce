...
<html>
    ...
    <body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-center" id="exampleModalLabel">Change Your Password</h5>
        ...
        <section class="container">
            <div>
                <form action="updateProfile.jsp" class="mt-4" method="POST">
                    <div class="row">
                        <div class="col-25"><label for="fname"><strong>Full Name</strong></label></div>
                        <div class="col-75"><input type="text" id="fname" name="fname" value="<%=rs.getString("CNAME")%>" disabled required /></div>
                    </div>
                    <div class="row">
                        <div class="col-25"><label for="email"><strong>Email</strong></label></div>
                        <div class="col-75"><input type="email" id="email" name="email" value="<%=rs.getString("CEMAIL")%>" disabled required /></div>
                    </div>
                    <div class="row">
                        <div class="col-25"><label for="phone"><strong>Contact No.</strong></label></div>
                        <div class="col-75"><input type="tel" id="phone" name="phone" value="<%=rs.getLong("CPHONE")%>" disabled required /></div>
                    </div>
                    <div class="row">
                        <div class="col-25"><label for="addrs"><strong>Address</strong></label></div>
                        <div class="col-75"><input type="text" id="addrs" name="addr" value="<%=rs.getString("CADDR")%>" disabled required /></div>
                    </div>
                    <div class="row">
                        <a href="#changePass" data-bs-toggle="modal"><p class="text-center fw-bold mt-3"><i class="fas fa-key"></i>Change password..?</p></a>
                    </div>
                    
                    <div class="row d-flex justify-content-center profile">
                        <button type="submit" value="" onclick="edit();"><i class="fas fa-pencil-alt"></i>EDIT</button>
                        <button type="submit" value="" ><i class="far fa-save"></i></i>UPDATE</button>
                    </div>
                </form>
            </div>
        </section>
